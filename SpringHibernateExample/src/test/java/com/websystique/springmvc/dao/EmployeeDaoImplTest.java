...
public class EmployeeDaoImplTest extends EntityDaoImplTest{
    ...
    */
    ...
    public void findById(){
        AssertJUnit.assertNotNull(employeeDao.findById(1));
        AssertJUnit.assertNull(employeeDao.findById(3));
    }
    ...
    public void saveEmployee(){
        ...
        AssertJUnit.assertEquals(employeeDao.findAllEmployees().size(), 3);
    }
     
    @Test
    public void deleteEmployeeBySsn(){
        employeeDao.deleteEmployeeBySsn("11111");
        AssertJUnit.assertEquals(employeeDao.findAllEmployees().size(), 1);
    }
     
    @Test
    public void deleteEmployeeByInvalidSsn(){
        employeeDao.deleteEmployeeBySsn("23423");
        AssertJUnit.assertEquals(employeeDao.findAllEmployees().size(), 2);
    }
    ...
    public void findEmployeeBySsn(){
        AssertJUnit.assertNotNull(employeeDao.findEmployeeBySsn("11111"));
        AssertJUnit.assertNull(employeeDao.findEmployeeBySsn("14545"));
    }
